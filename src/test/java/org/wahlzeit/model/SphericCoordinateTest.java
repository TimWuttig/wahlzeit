...
public class SphericCoordinateTest {
	...
	public void startup() {
		...
		negativeSphericCoordinate = new SphericCoordinate(7.412152184, 1.914826624, -2.697173444);
	...
	public void testGetCartesianDistance() {
		...
		assertEquals(positiveAndNegativeErg, positiveSphericCoordinate.getCartesianDistance(negativeSphericCoordinate),0.000000001);
		assertEquals(positiveAndMixedErg, positiveSphericCoordinate.getCartesianDistance(mixedSphericCoordinate),0.000000001);
		assertEquals(negativeAndMixedErg, negativeSphericCoordinate.getCartesianDistance(mixedSphericCoordinate),0.000000001);
