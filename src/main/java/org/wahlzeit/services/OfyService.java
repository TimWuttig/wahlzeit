...
import org.wahlzeit.model.Bike;
import org.wahlzeit.model.BikePhoto;
import org.wahlzeit.model.BikeType;
...
public class OfyService {
	...
	static {
		...
		factory().register(BikePhoto.class);
		...
		factory().register(BikeType.class);
	}
