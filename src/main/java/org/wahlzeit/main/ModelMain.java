...
import org.wahlzeit.model.BikePhotoFactory;
import org.wahlzeit.model.BikePhotoManager;
...
public abstract class ModelMain extends AbstractMain {
	...
	public void saveAll() throws IOException{
		...
		BikePhotoManager.getInstance().savePhotos();
	...
	protected void createUser(String userId, String nickName, String emailAddress, String photoDir) {
		...
		PhotoManager photoManager = BikePhotoManager.getInstance();
